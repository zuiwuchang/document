...
/************************************************************SSDT 相关*********************************************************/
#pragma PAGE_MEMORY
ULONG HOOKAPI GetCurSsdtFunctionAddr(ULONG index)
{
	ULONG function_addr;
	__asm
	{
...
#pragma PAGE_MEMORY
ULONG HOOKAPI SetCurSsdtFunctionAddr(ULONG index,ULONG addr)
{
	ULONG function_addr;
	__asm
	{
...
#pragma PAGE_MEMORY
__declspec(naked)
 PEPROCESS HOOKAPI MyPsGetCurrentProcessEx(VOID)
{
	__asm
	{
